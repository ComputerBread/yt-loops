...
function addLoop() {
  ...
  start = document.getElementById("in-start-timestamp").value;
  end = document.getElementById("in-end-timestamp").value;
...
// need to wait a bit before adding it
setTimeout(() => {
